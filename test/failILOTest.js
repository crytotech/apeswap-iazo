...
contract("Failed ILO", async (accounts) => {
    ...
    it("Should create and expose new ILO", async () => {
        ...
        await fabric.createILO(accounts[1], banana.address, wbnb.address, true, false, ["2000000000000000000", "1000000000000000000000000", "1000000000000000000000", blockNumber + 2, 28700, 60, "2000000000000000000000000", 30, 0], { from: accounts[1], value: 1000000000000000000 })
