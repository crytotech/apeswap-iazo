...
const WNativeMock = contract.fromArtifact("WNativeMock");
        ...
        // TODO: fullIAZO test copy
    // it("iazo info", async () => {
    //     const iazoInfo = await iazo.IAZO_INFO();
    //     console.dir({iazoInfo});
    //     const iazoFactoryLiquidityLocker = await iazoFactory.IAZO_LIQUIDITY_LOCKER();
    //     console.dir({iazoFactoryLiquidityLocker});
    //     const iazoLiquidityLocker = await iazo.IAZO_LIQUIDITY_LOCKER();
    //     console.dir({iazoLiquidityLocker});
    //     const iazoSettings = await iazo.IAZO_SETTINGS();
    //     console.dir({iazoSettings});
    //     const lockerApeFactory = await liquidityLocker.APE_FACTORY();
    //     console.dir({lockerApeFactory});
    //     const lockerExposer = await liquidityLocker.IAZO_EXPOSER();
    //     console.dir({lockerExposer});
    //     // FIXME: cc
    //     // assert.equal(
    //     //     iazoStatus,
    //     //     0,
...
describe('Scratch', async function () {
